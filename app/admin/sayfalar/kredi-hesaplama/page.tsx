...
import { Save, Loader2, ChevronLeft, Percent, AlertCircle, Settings, Layers, Wallet, Calendar, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0f172a] text-gray-100 relative">
      ...
      <div className="p-4 md:p-8 pb-32 max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/admin" className="p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors">
            <ChevronLeft className="text-slate-400" />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-white">Kredi Hesaplama Ayarları</h1>
            <p className="text-sm text-slate-400">Web sitesindeki hesaplama aracının parametrelerini buradan yönetebilirsiniz.</p>
          </div>
        </div>
